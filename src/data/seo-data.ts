...
export const products = [
  "Men's Shirts", "Women's Sarees", "Kids Wear", "Denim Jeans",
  "Cotton Kurtas", "Silk Sarees", "T-Shirts Wholesale",
  "Trousers Manufacturers", "Blouses", "Lehenga Choli",
  "Sherwani", "Dhoti", "Vests", "Underwear", "Socks",
  "Handkerchiefs", "Towels", "Bedsheets", "Curtains",
  "Table Linen", "Kitchen Aprons", "Uniforms", "Sports Wear",
  "Yoga Wear", "Swimwear", "Raincoats", "Jackets",
  "Sweaters", "Shawls", "Dupatta", "Stoles", "Ties",
  "Belts", "Gloves", "Caps", "Masks", "Ethnic Wear",
  ...
  "Basketball Jerseys", "Volleyball Kits", "Badminton Team Kits",
  "Marathon T-Shirts", "Chef Coats", "Safety Vests", "Reflective Jackets"
];

export const buyers = [
  "Wholesalers", "Retailers", "Textile Traders", "Apparel Exporters", "Online Sellers",
  "Ecommerce Platforms", "Department Stores", "Boutique Owners", "Fashion Designers",
...
export const sellers = [
  "Manufacturers", "Textile Mills", "Knitwear Producers", "Weaving Units", "Dyeing Units",
  "Printing Units", "Embroidery Services", "Packaging Suppliers", "Logistics Providers",
...
export const cityZones: Record<string, string[]> = {
  ...
  coimbatore: ['peelamedu', 'singanallur', 'gandhipuram', 'rathinapuri', 'saibaba-colony', 'goundampalayam', 'kavundampalayam', 'kk-pudur', 'ram-nagar', 'town-hall', 'saravanampatti', 'vadavalli', 'perur', 'pollachi-road'],
...
export const businessCategories = [
  "Exporters", "Importers", "Wholesalers", "Retailers", "Distributors", "Suppliers", "Manufacturers", "Producers", "Factories", "Units", "Mills",
...
export const services = [
  "Custom Manufacturing", "Private Label", "OEM Production", "ODM Services", "Cutting Services", "Stitching Services", "Embroidery", "Printing", "Dyeing", "Packaging",
  "Quality Inspection", "Sample Development", "Prototype Making", "Bulk Production", "Small Order Manufacturing", "Export Services", "Import Services",
  ...
  "Sublimation Printing", "Local Business Services", "AI SEO", "AEO Optimization", "Semantic Search", "Programmatic SEO", "Logo Digitizing",
  "Bulk Screen Printing", "Textile Quality Auditing"
];
...
export const geoLocations = [
  "Northern Districts", "Southern Districts", "Eastern Districts", "Western Districts", "Central Districts", "Coastal Districts", "Inland Districts",
  "Industrial Corridors", "Textile Corridors", "Export Processing Zones", "Special Economic Zones", "Industrial Parks", "Textile Parks", "Apparel Parks",
  "Knitwear Clusters", "Weaving Clusters", "Embroidery Clusters", "Printing Clusters", "Dyeing Clusters", "Spinning Hubs", "Textile Hubs",
  "Garment Hubs", "Export Houses", "Wholesale Markets", "Retail Markets", "Online Markets", "Trade Centers", "Business Districts", "Commercial Zones",
  "Industrial Belts", "Manufacturing Hubs", "Production Centers", "Processing Units", "Finishing Units", "Storage Warehouses", "Distribution Centers",
  "Logistics Hubs", "Transport Corridors", "Railway Networks", "Seaports Connectivity", "Airports Connectivity", "Highway Networks", "Industrial Estates",
  "Special Economic Zone", "Export Oriented Units", "100 Percent Export Units", "Specialized Export Zones", "Textile Processing Hubs", "Garment Finishing Hubs",
  "Quality Testing Labs", "Research Centers", "Training Institutes", "Skill Development Centers", "Government Offices", "Trade Associations",
