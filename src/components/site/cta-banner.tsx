        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
            <a
              ...
              className="bg-secondary text-on-secondary px-10 py-4 rounded-md font-label-md text-label-md uppercase tracking-[0.1em] hover:opacity-90 transition-opacity duration-300 inline-flex items-center justify-center gap-3 cursor-pointer"
            >
            ...
            <a
              ...
              className="bg-transparent border border-on-primary/30 text-on-primary px-10 py-4 rounded-md font-label-md text-label-md uppercase tracking-[0.1em] hover:bg-on-primary/10 hover:border-on-primary/50 transition-all duration-300 inline-flex items-center justify-center cursor-pointer"
            >
              Email Us
            </a>
          </div>
