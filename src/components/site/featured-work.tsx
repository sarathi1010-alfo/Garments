  ...
  return (
    <section id="featured" className="py-section-gap w-full bg-surface-container-low">
      <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop">
        <Reveal className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-12 md:mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12">
          {/* Row 1 — Large feature (left) + small (right, desktop offset) */}
          {/* Kabaddi Team Kit */}
          ...
          {/* Row 2 — Small (left) + large feature (right, desktop offset) — zigzag */}
          {/* Shorts */}
