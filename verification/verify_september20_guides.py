...
def run():
    ...
    slugs = [
        "computerized-multi-axis-automated-webbing-buckle-seating-stress-relief-anchorage-tactical-activewear",
        "theni-dindigul-natural-fiber-processing-eco-coating-sourcing",
        "recycled-nylon-66-4way-stretch-vs-bio-based-polyamide-410-dynamic-athletic-apparel"
    ]
