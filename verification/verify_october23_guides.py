...
async def main():
    ...
    try:
        async with async_playwright() as p:
            ...
            slugs = [
                "custom-sublimated-kabaddi-team-kits-fabric-engineering-manufacturing-guide",
                "tirupur-coimbatore-sportswear-knits-sublimation-printing-manufacturing-hub",
                "dye-sublimation-printing-vs-screen-printing-custom-sportswear-comparison"
            ]
