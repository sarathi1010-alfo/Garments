...
def run():
    ...
    slugs = [
        "computerized-multi-axis-automated-rivet-seating-strain-relief-reinforcement-heavy-athletic-accessories",
        "madurai-virudhunagar-technical-fabric-coating-export-logistics-sourcing",
        "recycled-nylon-66-4way-stretch-vs-bio-based-polyamide-610-outdoor-performance-apparel"
    ]
