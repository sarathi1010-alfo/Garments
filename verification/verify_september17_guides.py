...
def run():
    ...
    slugs = [
        "computerized-multi-axis-automated-snap-fastener-seating-seam-reinforcement-tactical-sportswear",
        "sattur-sivakasi-technical-filament-processing-export-logistics-sourcing",
