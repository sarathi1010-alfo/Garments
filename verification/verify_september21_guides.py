...
def run():
    ...
    slugs = [
        "computerized-multi-axis-automated-cargo-pocket-welder-thermal-film-bonding-tactical-activewear",
        "tirupur-erode-eco-friendly-organic-dyeing-finishing-infrastructure-sourcing",
        "recycled-nylon-66-4way-stretch-vs-bio-based-polyamide-56-extreme-endurance-activewear"
    ]
